...
set output '| ps2pdf - linecounter_alluxio_hdfs_execution_time.pdf'
...
plot "linecounter_alluxio_hdfs_execution_time.txt" using 2:xtic(1) title "Alluxio" with histogram lw 2 lc rgb "skyblue",\
