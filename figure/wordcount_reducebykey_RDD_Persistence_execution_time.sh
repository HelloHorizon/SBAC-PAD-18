...
set output '| ps2pdf - wordcount_reducebykey_RDD_Persistence_execution_time.pdf'
...
plot "wordcount_reducebykey_RDD_Persistence_execution_time.txt" using 2 title "Memory w Deserialized Java Objects" with linespoints lw 2,\
