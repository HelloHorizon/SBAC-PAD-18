...
set output '| ps2pdf - wordcount_reducebykey_memory_nvme_alluxio_execution_time.pdf'
...
plot "wordcount_reducebykey_memory_nvme_alluxio_execution_time.txt" using 2 title "Memory w Serialized Java Objects" with linespoints lw 2,\
